  ...
  if (isInstallable) {
    if (variant === 'menuitem') {
      return (
        <button
          ...
          className="w-full px-3 py-2 flex items-center gap-2 hover:bg-card-theme text-left transition text-xs"
        >
    ...
    return (
      <button
        ...
        title="Install NoLoginNotepad as a standalone app"
      >
