  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-1.5 sm:gap-2.5 min-w-0 flex-1">
        ...
        >
          <AppLogo size={28} />
          <span className="font-bold text-xs sm:text-sm tracking-tight hidden min-[360px]:inline text-primary-theme">NoLoginNotepad</span>
        </div>
      ...
      {/* Right controls: Full Screen, Install, Export, Settings, More */}
