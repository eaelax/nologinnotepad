...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://nologinpad.com/terms',
  },
};
        ...
        <div className="prose prose-stone dark:prose-invert max-w-none text-sm sm:text-base leading-relaxed space-y-6">
          <section className="space-y-3">
            ...
            <p className="text-stone-600 dark:text-stone-300">
              By accessing and using <strong>NoLoginNotepad</strong> (&quot;the Service&quot;), accessible via <a href="https://nologinpad.com" className="underline font-medium">nologinpad.com</a>, you agree to be bound by these Terms of Service. If you do not agree to these terms, please discontinue use of the service.
            </p>
          </section>
