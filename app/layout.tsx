...
export const metadata: Metadata = {
  metadataBase: new URL('https://www.nologinnotepad.com'),
  ...
  authors: [{ name: 'NoLoginNotepad Team', url: 'https://www.nologinnotepad.com' }],
  generator: 'Next.js',
  keywords: [
    'online notepad',
    'free online notepad',
  ...
  alternates: {
    canonical: 'https://www.nologinnotepad.com/',
  },
  ...
  openGraph: {
    ...
    url: 'https://www.nologinnotepad.com',
    siteName: 'NoLoginNotepad',
    locale: 'en_US',
    type: 'website',
    images: [
      {
        url: 'https://www.nologinnotepad.com/pwa-512x512.png',
        width: 512,
        height: 512,
  ...
  twitter: {
    ...
    description:
      'Write instantly with zero friction. 100% private, client-side auto-saving in IndexedDB, offline capability, ruled paper styles, and custom themes.',
    images: ['https://www.nologinnotepad.com/pwa-512x512.png'],
  },
  robots: {
    index: true,
    follow: true,
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  // Rich multi-schema structured data: WebApplication, FAQPage
  const structuredData = [
    {
      '@context': 'https://schema.org',
      '@type': 'WebApplication',
      '@id': 'https://www.nologinnotepad.com/#webapp',
      name: 'NoLoginNotepad',
      alternateName: [
    ...
    },
    {
      '@context': 'https://schema.org',
      '@type': 'FAQPage',
      '@id': 'https://www.nologinnotepad.com/#faq',
      mainEntity: [
        {
          '@type': 'Question',
