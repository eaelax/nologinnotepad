...
import { exportAllNotesBackup } from '@/lib/utils/export-import';
...
export default function NotepadPage() {
  ...
  // Content Change with In-Memory Update & Debounced IndexedDB + LocalStorage Backup
    ...
    (newContent: string) => {
      ...
      setNotes((prevNotes) => {
        return prevNotes.map((note) => {
          ...
          }, preferences.autoSaveDelayMs || 500);

          return updatedNote;
        });
      });
    },
    [activeNoteId, preferences.autoSaveDelayMs]
  );
