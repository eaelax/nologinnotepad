...
3. Enter your apex domain (e.g., `nologinpad.com`) or subdomain.
...
2. Click **Add Property** &rarr; select **Domain** (e.g., `nologinpad.com`) and add the TXT verification record in Cloudflare DNS.
